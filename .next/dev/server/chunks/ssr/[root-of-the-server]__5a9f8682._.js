...
function getQueryClient() {
    if (!client) {
        client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["QueryClient"]();
    }
    return client;
}
}),
...
const fetchNotes = async ({ search = '', page = 1, perPage = PER_PAGE } = {})=>{
    ...
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get('https://notehub-public.goit.study/api/notes', {
        params: {
            search,
            page,
            perPage
...
"[project]/lib/queryKeys.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queryKeys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/queryKeys.ts [app-rsc] (ecmascript)");
...
async function NotesPage() {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queryClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getQueryClient"])();
    await queryClient.prefetchQuery({
        queryKey: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queryKeys$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["notesKeys"].list(1),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a9f8682._.js.map