...
async function NoteDetailsPage({ params }) {
    const { id } = await params;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getQueryClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getQueryClient"])();
    await queryClient.prefetchQuery({
        queryKey: [
            'note',
            id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__653eb3b8._.js.map